    ...
    if auto:
        ...
        if "mesh_scan" in mission_data:
            ...
            try:
                ...
                # Turn on trajectory mode for path following
                ms.trajectory_mode_active = True
                ms.trajectory_type = "scan"
                ms.trajectory_object_center = tuple(
                    mission_data.get("target_position", [0, 0, 0])
                )
